...
const messages = {
  en: {
    fresh: "Street Food", yourOrder: "Your Order",
    ...
    notePlaceholder: "Special request? e.g. less spicy",
  },
  ko: {
    fresh: "길거리 음식", yourOrder: "주문 내역",
    ...
    notePlaceholder: "요청 사항이 있나요? 예: 덜 맵게 해주세요",
  },
  ms: {
    fresh: "Makanan Jalanan", yourOrder: "Pesanan Anda",
    ...
    notePlaceholder: "Ada permintaan khusus? cth. kurang pedas",
  },
} as const;
